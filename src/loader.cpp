...
bool Loader::loadTformFromROSBag(const std::string& bag_path, Odom* odom) {
  ...
  for (const rosbag::MessageInstance& m : view) {
    ...
    // Transform
    // T(Transform::Translation(transform_msg.transform.translation.y-2502787.987210464,
    //                                    transform_msg.transform.translation.x-197390.68866283743,
    //                                    transform_msg.transform.translation.z-95.84799999999996),
    //             Transform::Rotation(transform_msg.transform.rotation.w,
    //                                 transform_msg.transform.rotation.x,
    //                                 transform_msg.transform.rotation.y,
    //                                 transform_msg.transform.rotation.z));
