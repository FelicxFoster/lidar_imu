#ifndef LIDAR_IMU_LOADER_H_
#define LIDAR_IMU_LOADER_H_
...
POINT_CLOUD_REGISTER_POINT_STRUCT(
    lidar_imu::PointAllFields,
    (float, x, x)(float, y,
                  y)(float, z,
                     z)(int32_t, time_offset_us,
                        time_offset_us)(uint16_t, reflectivity,
                                        reflectivity)(uint16_t, intensity,
                                                      intensity)(uint8_t, ring,
                                                                 ring))

#endif  // LIDAR_IMU_LOADER_H_
